...
export const createTaskUtils = (deps) => {
  const { fs } = deps;
   ...
   */
  const generateTaskContent = (title, description, priority) => {
   ...
   */
  const buildTaskPath = (projectRoot, type, folder, taskId) => {
